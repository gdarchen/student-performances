...
Var_Name=[' School    ';' Sex       ';' Age       ';' Address   ';' Famsize   ';' Pstatus   ';' Medu      ';' Fedu      ';' Mjob      ';' Fjob      ';' Reason    ';' Guardian  ';' Traveltime';' Studytime ';' Failures  ';' Schoolsup ';' Famsup    ';' Paid      ';' Activities';' Nursery   ';' Higher    ';' Internet  ';' Romantic  ';' Famrel    ';' Freetime  ';' Goout     ';' Dalc      ';' Walc      ';' Health    ';' Absences  ';' 1ereNote  ';' 2emeNote  ';' NoteFinale'];
[n p]=size(X_Mat);
